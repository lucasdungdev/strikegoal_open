...
export const FireIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 12c0-2.5 1.5-5 3.5-6.5 0 0-2-2-3.5-2-1.5 0-3.5 2-3.5 4 0 2.5 1.5 5 3.5 6.5Z"/><path d="m14.5 15.5 1-1"/><path d="M7 14c-2.5-1.5-4-3.5-4-6C3 5.5 5.5 3 8.5 3c1.5 0 3 1 4 2.5"/><path d="M14.5 18.5c.5.5.5 1.5 0 2s-1.5.5-2 0c-.5-.5-1-1-1.5-1.5-1-1-1.5-2.5-1.5-4 0-2.5 1.5-5 3.5-6.5 1 .5 1.5 1.5 1.5 2.5 0 2.5-1.5 5-3.5 6.5Z"/>
    </svg>
);
